...
public class MainWindowController extends Controller implements Initializable {
    ...
    private void showCommentsOfProblem(Problem problem) {
        lOAUser.setCellValueFactory(cellData -> new SimpleStringProperty(cellData.getValue().getUser()));
        lOAAnswer.setCellValueFactory(cellData -> new SimpleStringProperty(cellData.getValue().getComment()));
        lOADate.setCellValueFactory(cellData -> new SimpleStringProperty(cellData.getValue().getDate()));
